...
{
    public partial class ActualizoSPUpdatecontact : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"EXEC(N'ALTER PROCEDURE [ApplicationDB].[Contact_Update] 
                        @Name VARCHAR(15), @Company VARCHAR(15), @Profile VARCHAR(15), @CountryCode VARCHAR(15), @StateCodePH VARCHAR(15), @NumberPH VARCHAR(15), @IsPersonal BIT, @CountryName VARCHAR(15), @CountryNumCode INT, @AlphaCode VARCHAR(15), @StateCode VARCHAR(15), @StateName VARCHAR(15), @ZipCode INT, @CityName VARCHAR(15), @AddressDetail VARCHAR(15), @Id VARCHAR(100) AS
                        BEGIN
